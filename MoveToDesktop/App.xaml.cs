...
namespace MoveToDesktop
{
    ...
    public partial class App : Application
    {
        ...
        static System.Drawing.Icon GetIcon(int index)
        {
            if (index <= 1)
                index = 1;
            string name = index <= 9 ? "_" + index : "9+";
            object obj = MoveToDesktop.Properties.Resources.ResourceManager.GetObject(name, MoveToDesktop.Properties.Resources.Culture);
        ...
        {
            notifyIcon.Icon = GetIcon(VirtualDesktop.GetCurrentDesktopIndex()+1);
        }
